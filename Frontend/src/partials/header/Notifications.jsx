          ...
          <ul>
            <li className="border-b border-slate-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2"><span className="font-medium text-slate-800">Steve </span><br/> Hello how are you doing?</span>
                <span className="block text-xs font-medium text-slate-400">12:47 AM</span>
              </Link>
            </li>
            <li className="border-b border-slate-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2"><span className="font-medium text-slate-800">Everlee</span><br/> My heart rate this week is so ...</span>
                <span className="block text-xs font-medium text-slate-400">9:23 AM</span>
              </Link>
            </li>
            <li className="border-b border-slate-200 last:border-0">
              <Link
                  ...
                  onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2"><span className="font-medium text-slate-800">Arya</span><br/> Meditation is awesome!</span>
                <span className="block text-xs font-medium text-slate-400">7:52 AM</span>
              </Link>
            </li>
          </ul>
        </div>
