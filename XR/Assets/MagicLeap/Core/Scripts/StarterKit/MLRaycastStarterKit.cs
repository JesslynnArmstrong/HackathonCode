...
namespace MagicLeap.Core.StarterKit
{
    ...
    public static class MLRaycastStarterKit
    {
        ...
        #if PLATFORM_LUMIN
        /// <summary>
        // Placement using full QueryParams object
        /// </summary>
        public static MLResult Raycast(MLRaycast.QueryParams parameters, MLRaycast.OnRaycastResultDelegate callback)
        {
            if (MLRaycast.IsStarted)
            {
                ...
                if (!_result.IsOk)
                {
                    Debug.LogErrorFormat("Error: MLRaycastStarterKit.Placement failed. Reason: {0}", _result);
                }
            }

            else
            {
                Debug.LogError("Error: MLRaycastStarterKit.Placement failed because MLRaycast was not started.");
        ...
        /// <summary>
        // Placement using just rayOrigin, rayDirection, and rayUpwardVector
        /// </summary>
        ...
        /// <summary>
        // Placement using just a transform reference
        /// </summary>
